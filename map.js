...
mapboxgl.accessToken = 'pk.eyJ1Ijoic3BhdHRhcHUxIiwiYSI6ImNtYXJreDkyczBieXcybG9nZ2dlcWRqZWgifQ.hG560fZS12j9f2ARwZkLDw';
...
map.on('load', async () => {
  ...
  function updateTimeDisplay() {
    let timeFilter = parseInt(timeSlider.value, 10);
